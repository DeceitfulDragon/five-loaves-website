    ...
    <section class="bg-mainColor text-center py-2">
      <ul class="space-y-2 md:space-y-0 md:flex md:justify-center md:space-x-6 px-2">
        <li class="bg-green-800 py-2 px-4 rounded-2xl flex items-center justify-center text-white">
          <i class="fa-regular fa-copyright"></i>&nbsp;&nbsp;{{ new Date().getFullYear() }} Five Loaves Food & Clothing.
          All rights reserved.
        </li>
        <li class="bg-green-800 py-2 px-4 rounded-2xl flex items-center justify-center text-white">
          <i class="fa-solid fa-heart"></i>&nbsp;&nbsp;This Institution is an Equal Opportunity Provider and TEFAP/USDA
          Food Provider.
        </li>
        <li class="bg-green-800 py-2 px-4 rounded-2xl flex items-center justify-center text-white">
